...
const ScrollableTabView = createReactClass({
  ...
  _keyExists(sceneKeys, key) {
    if (!sceneKeys || sceneKeys == undefined) return [];
  ...
  renderScrollableContent() {
    ...
    const decelerationRate = Platform.OS === 'android' ? 0 : null;
    const snapToAlignment = Platform.OS === 'android' ? 'center' : null;
    return <ScrollView
  ...
  _updateScrollValue(value) {
    ...
    this.props.onScroll(this.state.scrollValue);
  },
